...
3. Ao final, confira `status.md` / `timeline.md` se material. `.prompt-status` tem só 2 campos e atualiza **somente na entrada** (exceto Commit+Push). CCIA: gravar se relevante; ler só se você pedir.
